...
# }
$config_directories = [
  'sync' => '/var/www/belikethesquirrel/config/sync',
  'active' => '/var/www/belikethesquirrel/config/active',
  'staging' => '/var/www/belikethesquirrel/config/staging',
];
$settings['hash_salt'] = 'DDIbqwLA4RObXOO_kWzQunQNPZVJBRh_XX4CDOpHboYYqRo-jkeAUTKcGofrxl1Sfmecu_XBdw';
$settings['update_free_access'] = FALSE;
$settings['bootstrap_config_storage'] = array('Drupal\Core\Config\BootstrapConfigStorageFactory', 'getFileStorage');
$settings['container_yamls'][] = __DIR__ . '/services.yml';
